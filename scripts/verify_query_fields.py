...
_MAPPING: list[tuple[str, type[GenericModelRecord], type]] = [
    ("GenericF", GenericModelRecord, GenericFields),
    ("ImageF", ImageGenerationModelRecord, ImageFields),
    ("TextF", TextGenerationModelRecord, TextFields),
    ("ControlNetF", ControlNetModelRecord, ControlNetFields),
    ("ClipF", ClipModelRecord, ClipFields),
    ("BlipF", BlipModelRecord, BlipFields),
    ("CodeformerF", CodeformerModelRecord, CodeformerFields),
    ("EsrganF", EsrganModelRecord, EsrganFields),
    ("GfpganF", GfpganModelRecord, GfpganFields),
    ("SafetyCheckerF", SafetyCheckerModelRecord, SafetyCheckerFields),
    ("VideoF", VideoGenerationModelRecord, VideoFields),
    ("AudioF", AudioGenerationModelRecord, AudioFields),
    ("MiscellaneousF", MiscellaneousModelRecord, MiscellaneousFields),
]
