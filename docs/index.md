...
## Which entry point is mine?

This project is three things in one. Find the row that matches what you're building -- the
sections below are then organized by *how* you like to learn (by doing, by understanding, by
looking things up).
...
| Host the canonical dataset for others | Run the **FastAPI service** in PRIMARY mode | [Primary Deployments](reference/primary_deployments.md) |
...
_I have a specific task to accomplish._
