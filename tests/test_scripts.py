...
def test_download_all_model_references(base_path_for_tests: Path):
    reference_download_manager = ReferenceDownloadManager(base_path=base_path_for_tests)
    download_models = reference_download_manager.download_all_legacy_model_references(override_existing=True)
