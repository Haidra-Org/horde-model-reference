...
def test_validate_stable_diffusion_model_reference(tmp_path: Path) -> None:
    """Validate a fresh upstream reference without relying on shared machine cache state."""
